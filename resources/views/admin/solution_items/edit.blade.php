        ...
        <div class="col-xl-12 col-lg-12 mb-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.solution_items.update', ['solution_item' => $solution_item->id]) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{$solution_item->title }}" required>
                                @error('title')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea name="description" class="form-control summernote @error('description') is-invalid @enderror" required>{{ $solution_item->description }}</textarea>
                                @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
